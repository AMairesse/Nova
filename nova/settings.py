...
MIDDLEWARE = [
    ...
    'nova.middleware.StaticCacheControlMiddleware',
...
MESSAGE_COMPOSER_SOFT_TEXT_LIMIT_CHARS = _get_positive_int_env(
    "MESSAGE_COMPOSER_SOFT_TEXT_LIMIT_CHARS",
    8_000,
)
MESSAGE_COMPOSER_HARD_TEXT_LIMIT_CHARS = _get_positive_int_env(
    "MESSAGE_COMPOSER_HARD_TEXT_LIMIT_CHARS",
    12_000,
)
if MESSAGE_COMPOSER_HARD_TEXT_LIMIT_CHARS <= MESSAGE_COMPOSER_SOFT_TEXT_LIMIT_CHARS:
    raise ValueError(
        "MESSAGE_COMPOSER_HARD_TEXT_LIMIT_CHARS must be greater than "
        "MESSAGE_COMPOSER_SOFT_TEXT_LIMIT_CHARS"
    )
