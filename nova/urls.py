...
from .views.main_views import index, message_list, create_thread, delete_thread, add_message, stream_llm_response, task_detail
...
urlpatterns = [
    ...
    path("stream-llm-response/<int:thread_id>/", stream_llm_response, name="stream_llm_response"),
