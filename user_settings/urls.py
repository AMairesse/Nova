...
urlpatterns += [
    ...
    path(
        "tasks/templates/<str:template_id>/select-mailbox/",
        task_template_select_mailbox,
        name="task_template_select_mailbox",
    ),
    path("tasks/templates/<str:template_id>/setup/", task_template_setup, name="task_template_setup"),
